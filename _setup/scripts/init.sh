...
warn "  APP_STORE_CONNECT_KEY_ID        — from App Store Connect → Integrations"
warn "  APP_STORE_CONNECT_KEY_ISSUER_ID — from App Store Connect → Integrations"
warn "  APP_STORE_CONNECT_KEY_PATH      — path to your downloaded .p8 file"
echo ""
